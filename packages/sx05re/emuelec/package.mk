...
if [ "${ARCH}" == "aarch64" ]; then
  ...
  OFF_PKG_DEPENDS_TARGET+=" swanstation \
                        lib32-essential \
                        lib32-retroarch \
                        emuelec-32bit-info \
                        lib32-flycast \
  ...
  if [ "${DEVICE}" == "Amlogic-ng" ] || [ "${DEVICE}" == "Amlogic-no" ] || [ "${DEVICE}" == "RK356x" ] || [ "${DEVICE}" == "OdroidM1" ]; then
    OFF_PKG_DEPENDS_TARGET+=" dolphinSA"
  fi
